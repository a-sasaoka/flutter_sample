...
void main() {
  test('pushNotificationServiceProvider が PushNotificationService インスタンスを提供し、 '
      'onNotificationTap で notificationProvider に通知が伝播すること', () async {
  ...
  test('localeProvider にサポート対象外の言語（fr-FR）が指定されている場合、 '
      'デフォルトのサポート言語（en）にフォールバックすること', () async {
    final mockTalker = MockTalker();
    final container = ProviderContainer(
      overrides: [
