            ...
            children: [
              if (flavor != Flavor.prod) ...[
                ...
                _MenuTile(
                  ...
                  title: l10n.devImageCacheTitle,
                  onTap: () => const ImageCacheDemoRoute().push<void>(context),
                ),
                const Divider(height: 1, indent: 56),
                _MenuTile(
                  icon: Icons.speed_outlined,
                  title: l10n.devRebuildTitle,
                  onTap: () => const RebuildDemoRoute().push<void>(context),
                ),
                const Divider(height: 1, indent: 56),
                _MenuTile(
                  icon: Icons.share_outlined,
                  title: l10n.homeShareTitle,
                  onTap: () => const ShareDemoRoute().push<void>(context),
                ),
                const Divider(height: 1, indent: 56),
                _MenuTile(
