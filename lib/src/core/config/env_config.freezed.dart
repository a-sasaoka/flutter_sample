...
/// API ベース URL
 ...
 bool get useAgentPlatform;/// Google Directions API の URL
 String get googleDirectionsApiUrl;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EnvConfigState&&(identical(other.baseUrl, baseUrl) || other.baseUrl == baseUrl)&&(identical(other.aiModel, aiModel) || other.aiModel == aiModel)&&(identical(other.connectTimeout, connectTimeout) || other.connectTimeout == connectTimeout)&&(identical(other.receiveTimeout, receiveTimeout) || other.receiveTimeout == receiveTimeout)&&(identical(other.sendTimeout, sendTimeout) || other.sendTimeout == sendTimeout)&&(identical(other.useFirebaseAuth, useFirebaseAuth) || other.useFirebaseAuth == useFirebaseAuth)&&(identical(other.useAgentPlatform, useAgentPlatform) || other.useAgentPlatform == useAgentPlatform)&&(identical(other.googleDirectionsApiUrl, googleDirectionsApiUrl) || other.googleDirectionsApiUrl == googleDirectionsApiUrl));
}


@override
int get hashCode => Object.hash(runtimeType,baseUrl,aiModel,connectTimeout,receiveTimeout,sendTimeout,useFirebaseAuth,useAgentPlatform,googleDirectionsApiUrl);

@override
String toString() {
  return 'EnvConfigState(baseUrl: $baseUrl, aiModel: $aiModel, connectTimeout: $connectTimeout, receiveTimeout: $receiveTimeout, sendTimeout: $sendTimeout, useFirebaseAuth: $useFirebaseAuth, useAgentPlatform: $useAgentPlatform, googleDirectionsApiUrl: $googleDirectionsApiUrl)';
}
...
@useResult
$Res call({
 String baseUrl, String aiModel, int connectTimeout, int receiveTimeout, int sendTimeout, bool useFirebaseAuth, bool useAgentPlatform, String googleDirectionsApiUrl
});
...
/// Create a copy of EnvConfigState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? baseUrl = null,Object? aiModel = null,Object? connectTimeout = null,Object? receiveTimeout = null,Object? sendTimeout = null,Object? useFirebaseAuth = null,Object? useAgentPlatform = null,Object? googleDirectionsApiUrl = null,}) {
...
as bool,googleDirectionsApiUrl: null == googleDirectionsApiUrl ? _self.googleDirectionsApiUrl : googleDirectionsApiUrl // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String baseUrl,  String aiModel,  int connectTimeout,  int receiveTimeout,  int sendTimeout,  bool useFirebaseAuth,  bool useAgentPlatform,  String googleDirectionsApiUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EnvConfigState() when $default != null:
return $default(_that.baseUrl,_that.aiModel,_that.connectTimeout,_that.receiveTimeout,_that.sendTimeout,_that.useFirebaseAuth,_that.useAgentPlatform,_that.googleDirectionsApiUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String baseUrl,  String aiModel,  int connectTimeout,  int receiveTimeout,  int sendTimeout,  bool useFirebaseAuth,  bool useAgentPlatform,  String googleDirectionsApiUrl)  $default,) {final _that = this;
switch (_that) {
case _EnvConfigState():
return $default(_that.baseUrl,_that.aiModel,_that.connectTimeout,_that.receiveTimeout,_that.sendTimeout,_that.useFirebaseAuth,_that.useAgentPlatform,_that.googleDirectionsApiUrl);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String baseUrl,  String aiModel,  int connectTimeout,  int receiveTimeout,  int sendTimeout,  bool useFirebaseAuth,  bool useAgentPlatform,  String googleDirectionsApiUrl)?  $default,) {final _that = this;
switch (_that) {
case _EnvConfigState() when $default != null:
return $default(_that.baseUrl,_that.aiModel,_that.connectTimeout,_that.receiveTimeout,_that.sendTimeout,_that.useFirebaseAuth,_that.useAgentPlatform,_that.googleDirectionsApiUrl);case _:
  return null;
...
class _EnvConfigState extends EnvConfigState {
  const _EnvConfigState({required this.baseUrl, required this.aiModel, required this.connectTimeout, required this.receiveTimeout, required this.sendTimeout, required this.useFirebaseAuth, required this.useAgentPlatform, required this.googleDirectionsApiUrl}): super._();
...
@override final  String googleDirectionsApiUrl;
...
/// Create a copy of EnvConfigState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? baseUrl = null,Object? aiModel = null,Object? connectTimeout = null,Object? receiveTimeout = null,Object? sendTimeout = null,Object? useFirebaseAuth = null,Object? useAgentPlatform = null,Object? googleDirectionsApiUrl = null,}) {
