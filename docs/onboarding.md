...
- **[onboarding_screen.dart](file:///Users/a.sasaoka/develop/flutter/flutter_sample/lib/src/features/onboarding/presentation/onboarding_screen.dart)**
...
- **[onboarding_notifier.dart](file:///Users/a.sasaoka/develop/flutter/flutter_sample/lib/src/features/onboarding/application/onboarding_notifier.dart)**
...
- **[onboarding_routes.dart](file:///Users/a.sasaoka/develop/flutter/flutter_sample/lib/src/app/router/routes/onboarding_routes.dart)**
  - `GoRouter` を使って、オンボーディング画面を `/onboarding` というパスで登録しています。
- **[auth_guard.dart](file:///Users/a.sasaoka/develop/flutter/flutter_sample/lib/src/app/router/auth_guard.dart) / [firebase_auth_guard.dart](file:///Users/a.sasaoka/develop/flutter/flutter_sample/lib/src/app/router/firebase_auth_guard.dart)**
...
1. **単体テスト ([onboarding_notifier_test.dart](file:///Users/a.sasaoka/develop/flutter/flutter_sample/test/src/features/onboarding/application/onboarding_notifier_test.dart))**
   - 初期起動時にデータがない場合は「未完了 (false)」を返すこと。
   - すでに完了フラグがある場合は「完了 (true)」を返すこと。
   - 完了ボタンを押した際に正しくデータが保存されること。
   - これらを `package:checks` を使って検証しています。
2. **ウィジェットテスト ([onboarding_screen_test.dart](file:///Users/a.sasaoka/develop/flutter/flutter_sample/test/src/features/onboarding/presentation/onboarding_screen_test.dart))**
   - スライドをめくったときにタイトルや文章が切り替わること。
   - ボタン表示が「次へ」から「はじめる」に変わること。
   - 「スキップ」や「はじめる」をタップすると完了処理が呼ばれること。
3. **ゴールデンテスト ([onboarding_screen_golden_test.dart](file:///Users/a.sasaoka/develop/flutter/flutter_sample/test/src/features/onboarding/presentation/onboarding_screen_golden_test.dart))**
